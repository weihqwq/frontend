...
const CivilServiceExamSection = () => {
  ...
  return (
    <div className="civil-service-exam-section">
      {/* 公务员笔试标题 */}
      <div className="exam-divider-text">
        公务员笔试
      </div>
      ...
      <div className="exam-images">
        <div className="rounded-area">
          <img onClick={() => navigate(`/Administrative?jwt=${jwt}`)} src={process.env.PUBLIC_URL + '/images/xingce.png'} alt="行测" />
          <div className="exam-buttons">
            
            <button onClick={() => navigate(`/Administrative?jwt=${jwt}`)} >行测</button>
            
          </div>
        </div>
        <div className="rounded-area">
          <img onClick={() => navigate(`/Deuteronomy?jwt=${jwt}`)} src={process.env.PUBLIC_URL + '/images/shenlun.png'} alt="申论" />
          <div className="exam-buttons">
            
            <button onClick={() => navigate(`/Deuteronomy?jwt=${jwt}`)}> 申论</button>
