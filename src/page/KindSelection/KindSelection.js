...
const KindSelection = () => {
    ...
    const fetchPapers = async () => {
      try {
        const response = await fetch(
          "https://testsystem.zeabur.app/writtenTest/Paper/get",
          {
            method: "GET",
            headers: {
              Authorization: jwt,
  ...
  return (
    <div className="paper-selection-container_01">
      <button
      ...
      <button
        onClick={() => navigate(`/Kind1?jwt=${jwt}`)}
        style={{
          width: "50%",
          height: "100px",
          fontSize: "32px",
      ...
      <button
        onClick={() => navigate(`/Kind2?jwt=${jwt}`)}
        style={{
          width: "50%",
          height: "100px",
          fontSize: "32px",
      ...
      <button
        onClick={() => navigate(`/Kind3?jwt=${jwt}`)}
        style={{
          width: "50%",
          height: "100px",
          fontSize: "32px",
      ...
      <button
        onClick={() => navigate(`/Kind4?jwt=${jwt}`)}
        style={{
          width: "50%",
          height: "100px",
          fontSize: "32px",
